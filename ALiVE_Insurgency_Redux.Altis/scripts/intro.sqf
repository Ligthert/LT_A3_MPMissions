...
if (hasInterface) then {
    ...
    [] spawn {
	    ...
	    titleText ["Lowlands Tactical presents..", "BLACK IN",9999];
		0 fadesound 0;
		...
		titleText ["I N S U R G E N C Y", "BLACK IN",10];
		10 fadesound 0.9;
		_cam CamCommit 20;
		sleep 5;
		sleep 15;
        ...
        _title = "<t size='1.2' color='#e5b348' shadow='1' shadowColor='#000000'>INSURGENCY | ALiVE</t>
		<img color='#ffffff' image='media\images\img_line_ca.paa' align='left' size='0.60' /><br/>";
        _text = format["%1<t>Join our teamspeak 3 channel (ts.lowtac.nl ps: LowTac) to meet up with other player squads.</t>
		<br/><br/><img color='#ffffff' image='media\images\img_line_ca.paa' align='left' size='0.60' />",_title];
