...
BLUFOR: Zuiver Bolabongo van Insurgents.<br/>
Gebruik de helicopter voor transport (piloot) en om te scouten (co-piloot).<br/>
<br/>
REDFOR: Blijf in het rode omlijnde gebied en voorkom dat BLUFOR Bolabonga zuivert.<br/>
"]];
