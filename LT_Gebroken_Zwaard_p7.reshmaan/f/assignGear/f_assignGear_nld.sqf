...
// Backpacks
_bagsmall = "NLD_DST_Carryall_Empty";			// carries 120, weighs 20
_bagmedium = "NLD_DST_Carryall_Empty";				// carries 240, weighs 30
_baglarge =  "NLD_DST_Carryall_Empty"; 			// carries 320, weighs 40
