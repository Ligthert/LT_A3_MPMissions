...
//Remove Weapon
vas_r_weapons = ["optic_NVS","optic_Nightstalker","optic_tws","optic_tws_mg","Laserdesignator"];
vas_r_backpacks = [];
//Magazines to remove from VAS
vas_r_magazines = [];
//Items to remove from VAS
vas_r_items = ["optic_NVS","optic_Nightstalker","optic_tws","optic_tws_mg","Laserdesignator"];
