...

{
	...
	switch (f_param_backpacks) do {
        case 1: {
					_x removeWeaponTurret ["missiles_ASRAAM",[-1]];
					_x removeWeaponTurret ["missiles_Zephyr",[-1]];
					_x removeMagazineTurret ["300Rnd_20mm_shells", [-1]];
        ...
        case 2: {
					_x removeWeaponTurret ["missiles_ASRAAM",[-1]];
					_x removeWeaponTurret ["Twin_Cannon_20mm",[-1]];
					_x removeWeaponTurret ["missiles_Zephyr",[-1]];
