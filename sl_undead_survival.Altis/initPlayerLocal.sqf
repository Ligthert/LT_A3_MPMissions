...
// Move the player if they aren't JIP
if !([] call bis_fnc_didJip) then {
	waitUntil { player distance (getMarkerPos "respawn_civilian") > 100 };
	player setPos ([getMarkerPos "respawn_civilian",5,(random 360)] call bis_fnc_relPos);
};